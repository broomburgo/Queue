...
public struct Queue
{
  ...
  /// a couple of static properties, to conveniently initialize a reference to the main queue or to the default priority global queue
  ...
  /// the 'execute' method wraps the basic functionality of the class
